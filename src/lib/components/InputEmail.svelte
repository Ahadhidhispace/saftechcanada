...
<div class="relative max-h-fit transition-all duration-500 ease-out">
	<input
		...
		type="email"
		class="peer m-0 block h-[60px] w-full rounded-lg bg-saftech-white focus:ring-0 px-4 pr-16 py-4 text-base font-bold leading-tight text-saftech-black/70 placeholder:text-saftech-black/80 placeholder:font-bold focus:placeholder:opacity-10 border-none focus:border-none pb-[0.600rem] focus:pb-[0.625rem] pt-[1.300rem] focus:pt-[1.625rem] focus:text-saftech-black/70 {error
