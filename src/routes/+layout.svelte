...
<!--  -->
<div
	class="opacity-20 fixed bg-transparent top-[80%] left-[95%] z-[999] w-[50px] h-[50px] flex flex-grow-0 shrink-0 justify-center items-center rounded-full"
>
	<button
		type="button"
	...
	<div
		class="absolute rounded-full inset-0 bg-saftech-black w-[50px] h-[50px] pointer-events-none animate-ping"
	></div>
</div>
